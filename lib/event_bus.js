...
// Whether anyone is listening on `key` right now (a settlement id with an
// open stream = that player is online).
...
module.exports = { subscribe, publish, stats, hasSubscribers };
