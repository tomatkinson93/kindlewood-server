...
(function (global) {
  ...
  if (_isNodeEnv) {
    ...
    try { _nodeCards.DEFS   = require('./card_definitions'); } catch (e) {}
    try { _nodeCards.ENGINE = require('./card_engine'); }      catch (e) {}
    try { _nodeCards.COMBAT = require('./card_combat'); }      catch (e) {}
  }
  function _cards() {
  ...
  // ── Build a battle ───────────────────────────────────────────────────────
  function createBattle({ players, enemies, scene, seed, deck, deckSeed }) {
